...
export const DividendBody = () => {
  ...
  return (
    <Flex gap="12px">
      <Box w="60%" rounded="14px" bg="text.700">
        <Box p="20px">
        ...
        <Box p="20px" borderTop="1px solid" borderColor="text.900">
          ...
          <Flex justify="space-between">
            <InfoItem name="min_estimated_value" value="$10" color="sec.1" />
      ...
      <Flex w="40%" rounded="14px" bg="text.700" flexDir="column">
...
const InfoItem = ({ color, value, name }: InfoItemProps) => {
  const { t } = useTranslation();
  return (
    <Flex align="center">
